...
(function() {
	var LanguagePicker = function(element) {
		...
		this.arrowSvgPath = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: #000;transform: ;msFilter:;"><path d="M16.293 9.293 12 13.586 7.707 9.293l-1.414 1.414L12 16.414l5.707-5.707z"></path></svg>';
    ...
    // Devuelve la URL del archivo basado en el valor del idioma
    switch(option.value) {
        default:
            return 'indexes.html'; // URL predeterminada en caso de no coincidir
    }
}
...
function initLanguageSelection(picker) {
    picker.element.getElementsByClassName('language-picker__list')[0].addEventListener('click', function(event){
        ...
        if(language.hasAttribute('aria-selected') && language.getAttribute('aria-selected') == 'true') {
            ...
            // Redirigir al usuario a la URL del idioma seleccionado
            window.location.href = getLanguageUrl(language);
        }
    });
}
